<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddsubCategory.aspx.cs" Inherits="pETSHOPZ.AddsubCategory" %>
    ...
    <div clss="container">
        <div class="form-horizontal">
            ...
            <div class="form-btn-group">
                ...
                <div class="col-md-6">
                    <asp:Button ID="btnAddCategory" CssClass="btn btn-success" runat="server" Text="Ädd" Onclick="btnAddSubCategory_Click"  />
            </div>
        </div>
