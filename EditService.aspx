<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="EditService.aspx.cs" Inherits="pETSHOPZ.EditService" %>
         ...
         <div class="form-group">
          ...
          <div class="col-md-6">
             ...
             <div class="row">
                ...
                <br />
                 <asp:TextBox ID="txtFilterGrid1Record" style="border:2px solid blue" CssClass="form-control" runat="server" placeholder="Search Service...." onkeyup="Search_Gridview(this)"></asp:TextBox>
                <hr />
